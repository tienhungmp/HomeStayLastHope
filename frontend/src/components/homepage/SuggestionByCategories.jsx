		...
		<section className="container mx-auto pb-16">
			...
			<div className="flex flex-wrap gap-4">
				...
				>
					...
					/>
					<p className="text-center text-xl font-bold">Homestay Núi</p>
				</div>
				<div
					className="w-full flex-1 cursor-pointer text-center"
				...
				>
					<img
						...
						className="mb-2 aspect-[3/2] w-full rounded-lg"
					/>
					<p className="text-center text-xl font-bold">Homestay Ven Suối</p>
				</div>
				<div
					className="w-full flex-1 cursor-pointer text-center"
				...
				>
					<img
						...
						className="mb-2 aspect-[3/2] w-full rounded-lg"
					/>
					<p className="text-center text-xl font-bold">Nhà Gỗ Homestay</p>
				</div>
				<div
					className="w-full flex-1 cursor-pointer text-center"
				...
				>
					<img
						...
						className="mb-2 aspect-[3/2] w-full rounded-lg"
					/>
					<p className="text-center text-xl font-bold">Nhà Sàn Homestay</p>
				</div>
			</div>
		</section>
	)
